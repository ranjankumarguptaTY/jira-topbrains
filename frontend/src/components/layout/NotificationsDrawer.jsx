...
const INITIAL_NOTIFICATIONS = [
  {
    ...
    subtitle: 'Added cryptographic SHA-256 verifier generation for TopBrains OAuth.',
    time: '15m ago',
    unread: true,
    issueKey: 'TOP-3',
  },
  {
    ...
    subtitle: 'TopBrains Admin started the 2-week active sprint with 5 committed tickets.',
    time: '2h ago',
    unread: true,
    issueKey: null,
  },
  {
    ...
    subtitle: 'Role-Based Access Control (RBAC) middleware for TopBrains routes.',
    time: '1d ago',
    unread: true,
    issueKey: 'TOP-6',
  },
